...
This repository hosts **Valuify**, a .NET source generator and analyzers solution.
...
- Production code resides in `src/Valuify`.
- Tests live in `src/Valuify.Tests` and mirror the main project layout.
