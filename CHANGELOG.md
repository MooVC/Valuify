...
- Indexer properties are no longer treated as compatible properties when determining Valuify semantics.

# [1.7.3] - 2026-01-05

## Fixed

- Escaped braces in generated `ToString` output to prevent `FormatException` when rendering type braces.
