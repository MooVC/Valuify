namespace Valuify.Model
{
        ...
        : Value<Subject>
    {
        ...
        /// </value>
        public IReadOnlyList<Nesting> Nesting { get; set; } = Array.Empty<Nesting>();

        /// <summary>
        /// Gets or sets the properties declared within the subject.
        /// </summary>
        /// <value>
        /// The properties declared within the subject.
        /// </value>
