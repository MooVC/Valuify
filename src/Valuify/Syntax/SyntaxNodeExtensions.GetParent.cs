namespace Valuify.Syntax
{
    ...
    internal static partial class SyntaxNodeExtensions
    {
        ...
        /// The syntax type of the parent node.
        /// </typeparam>
        /// <param name="syntax">
        /// The node for which the parent symbol is to be identified and returned.
        /// </param>
        /// <param name="context">
        ...
        /// </param>
        /// <returns>
        /// The <see cref="ISymbol"/> assoicated with the parent node, if found, otherwise <see langword="null"/>.
        /// </returns>
